...
L["Trade Items"] = true
L["Show a + line for items received in a trade and a - line for items you give. Requires the Loot filter."] = true
...
L["Quests"] = true
L["Prettify Quest Status"] = true
L["Tidy up and class-colour the quest status messages shown for other players. Requires the Quests filter."] = true
