...
L["Trade Items"] = "Oggetti scambiati"
L["Show a + line for items received in a trade and a - line for items you give. Requires the Loot filter."] = 'Mostra una riga con "+" per gli oggetti ricevuti in uno scambio e una riga con "-" per gli oggetti che dai. Richiede il filtro "Bottino".'
...
L["Quests"] = "Missioni"
L["Prettify Quest Status"] = "Abbellisci lo stato delle missioni"
L["Tidy up and class-colour the quest status messages shown for other players. Requires the Quests filter."] = 'Riordina i messaggi di stato delle missioni degli altri giocatori e colora il nome in base alla classe. Richiede il filtro "Missioni".'
